        ...
        <div className="w-full max-w-300 mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
          <div className="space-y-8 mt-3">
            ...
            <div className="flex flex-col gap-0">
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-headline font-bold leading-none tracking-tighter text-glow">
                I CREATE
              </h1>
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-headline font-bold leading-none tracking-tighter text-glow text-primary min-h-30 sm:min-h-45">
